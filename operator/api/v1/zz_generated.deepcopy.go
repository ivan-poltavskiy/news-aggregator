...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConfigMapValidator) DeepCopyInto(out *ConfigMapValidator) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigMapValidator.
func (in *ConfigMapValidator) DeepCopy() *ConfigMapValidator {
	if in == nil {
		return nil
	}
	out := new(ConfigMapValidator)
	in.DeepCopyInto(out)
	return out
}
