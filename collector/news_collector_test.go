...
func beforeEach() {
	...
	sources := []source.Source{
		{Name: "bbc", PathToFile: "../news/bbc-world-category-19-05-24.xml", SourceType: "RSS"},
		{Name: "nbc", PathToFile: "../news/nbc-news.json", SourceType: "JSON"},
	}
...
func TestFindNewsForCurrentSource(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Test for bbc source",
			args: args{
				currentSource: source.Source{Name: "bbc", PathToFile: "../news/bbc-world-category-19-05-24.xml", SourceType: "RSS"},
				name:          "bbc",
			},
			wantQuantity: 54,
		},
		...
		{name: "Test for nbc source",
			args: args{
				currentSource: source.Source{Name: "nbc", PathToFile: "../news/nbc-news.json", SourceType: "JSON"},
				name:          "nbc",
			},
			wantQuantity: 100,
		},
